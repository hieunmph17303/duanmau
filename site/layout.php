...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarsExampleDefault">
                    <ul class="navbar-nav m-auto">
                        <li class="nav-item">
                            <a class="nav-link <?php if ($act == 'home' || !$act) {
                                                    echo 'active';
                                                } ?>" href="index.php?act=home">Trang chủ <span
                                    class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item <?php if ($act == 'sanpham') {
                                                echo 'active';
                                            } ?>">
                            <a class="nav-link" href="index.php?act=sanpham">Sản phẩm</a>
                        </li>
                        <li class="nav-item <?php if ($act == 'gioithieu') {
                                                echo 'active';
                                            } ?>">
                            <a class="nav-link" href="index.php?act=gioithieu">Giới thiệu</a>
                        </li>
                        <li class="nav-item <?php if ($act == 'lienhe') {
                                                echo 'active';
                                            } ?>">
                            <a class="nav-link" href="index.php?act=lienhe">Liên hệ</a>
                        </li>
                        <li class="nav-item <?php if ($act == 'chinhsach') {
                                                echo 'active';
                                            } ?>">
                            <a class="nav-link" href="index.php?act=chinhsach">Chính sách</a>
                        </li>
                    </ul>
    ...
    <section class="jumbotron text-center mb-1 bg-img">
        <div class="container">
            <h1 class="jumbotron-heading">Xshop - Trang thương mại điện tử lớn nhất Việt Nam</h1>
            <p class="lead text-muted mb-0">Ở đây có tất cả những thứ bạn tìm kiếm.</p>
        </div>
    </section>
