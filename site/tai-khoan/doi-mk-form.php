...
<div class="card mx-auto" style="max-width: 380px; margin-top:100px;">
    <div class="card-body">
        ...
        <form action="<?= $SITE_URL ?>/tai-khoan/doi-mk.php" method="POST">

            <div class="form-group">
                <label for="email" class="form-label">Tài khoản(tên đăng nhập)</label>
                <input name="ma_kh" class="form-control" placeholder="Username" type="text">
            </div> <!-- form-group// -->
            ...
            <div class="form-group">
                ...
                <input name="mat_khau2" class="form-control" placeholder="Username" type="password">
            </div> <!-- form-group// -->
